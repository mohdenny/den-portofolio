...
export const data = [
  { thumb: 'devgram-thumb.png', title: 'Devgram', desc: 'Devgram is a social media for developers, they can create developer profiles/portfolios, share posts and get help from other developers. Built with: NodeJS (ExpressJS), ReactJS (React Router, Redux, Axios), Vanilla CSS, JWT, MongoDB.', url: 'https://devgram-app.herokuapp.com/' },
  { thumb: 'Bisnis.com-Spirit-Indonesia-thumb.png', title: 'Bisnis.com (Spirit Indonesia!)', desc: 'This is part of the 75th edition of Bisnis.com Indonesian Independence page with the theme "\Spirit Membangun Indonesia Maju!"\ in 2020. Built with: ReactJS, Tailwindcss.', url: 'https://blissful-perlman-ba1151.netlify.app/' },
  ...
  { thumb: 'gitrepos-thumb.png', title: 'Gitrepos', desc: 'Gitrepos is a web app that uses the API from github, so it can search someones github repository. Built with: ReactJS (React Router, Redux, Axios), Tailwindcss.', url: 'https://infallible-poincare-6ad975.netlify.app/' },
  { thumb: 'denpic-thumb.png', title: 'Denpic', desc: 'Denpic is a web application that uses the stock photography provider API from Unsplash, so it can search for beautiful free stock photos. Built with: ReactJS (Axios), Vanilla CSS.', url: 'https://relaxed-hodgkin-3cfeb1.netlify.app/' },
